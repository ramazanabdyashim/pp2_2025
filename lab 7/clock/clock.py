...
while not done: 
    ...
    rotated_rightarm = pygame.transform.rotate(pravo, minuteAngle)
    
    pravoRect = rotated_rightarm.get_rect(center=(500, 400))
    screen.blit(rotated_rightarm, pravoRect)

    rotated_leftarm = pygame.transform.rotate(levo, secondAngle)
    
    levoRect = rotated_leftarm.get_rect(center=(500, 400))
    screen.blit(rotated_leftarm, levoRect)
